...
class Pr_features():
    def __init__(self,features=['problem_number','exercise_problem_repeat_session', 'total_sec_taken','total_attempt_cnt','used_hint_cnt', 'level'],features_to_be_time_encoded=['timestamp_TW'],features_to_be_OR_encoded=[],features_to_be_OH_encoded=['is_correct', 'is_hint_used', 'is_downgrade','is_upgrade'],features_meta=['uuid', 'ucid', 'upid']):
...
class Ex_features():
    def __init__(self, features=[],features_to_be_time_encoded=[],features_to_be_OR_encoded=['difficulty', 'learning_stage'],features_to_be_OH_encoded=['level2_id', 'level3_id', 'level4_id'],features_meta=['ucid']):
        self.features = features
        self.features_to_be_time_encoded = features_to_be_time_encoded
        self.features_to_be_OR_encoded = features_to_be_OR_encoded
        self.features_to_be_OH_encoded = features_to_be_OH_encoded
...
class U_features():
    def __init__(self,features=['points','badges_cnt','user_grade','has_teacher_cnt','has_student_cnt','belongs_to_class_cnt','has_class_cnt'],features_to_be_time_encoded=['first_login_date_TW'],features_to_be_OR_encoded=[],features_to_be_OH_encoded=['gender','user_city','is_self_coach'],features_meta=['uuid']):
        self.features = features
        self.features_to_be_time_encoded = features_to_be_time_encoded
        self.features_to_be_OR_encoded = features_to_be_OR_encoded
        self.features_to_be_OH_encoded = features_to_be_OH_encoded
